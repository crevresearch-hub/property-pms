...
export function getDefaultContractContent(): ContractContent {
  return {
    ...
    fees: [
      { serviceEn: 'New Lease Commission (Residential)', serviceAr: 'عمولة عقد إيجار جديد (سكني)', amount: '5% of annual rent (or AED 1,050 min, VAT inclusive)', remarksEn: 'For each new lease concluded', remarksAr: 'لكل عقد إيجار جديد يتم إبرامه', beneficiary: 'CRE' },
      { serviceEn: 'New Lease Commission (Commercial)', serviceAr: 'عمولة عقد إيجار جديد (تجاري)', amount: '10% of annual rent (or AED 1,050 min, VAT inclusive)', remarksEn: 'For each new lease concluded', remarksAr: 'لكل عقد إيجار جديد يتم إبرامه', beneficiary: 'CRE' },
      { serviceEn: 'Renewal Fee (Residential)', serviceAr: 'رسوم تجديد العقد (سكني)', amount: 'AED 850 (VAT inclusive)', remarksEn: 'For each tenancy renewal', remarksAr: 'لكل تجديد عقد إيجار', beneficiary: 'CRE' },
      { serviceEn: 'Renewal Fee (Commercial)', serviceAr: 'رسوم تجديد العقد (تجاري)', amount: 'AED 1,500 (VAT inclusive)', remarksEn: 'For each tenancy renewal', remarksAr: 'لكل تجديد عقد إيجار', beneficiary: 'CRE' },
      { serviceEn: 'EJARI Registration', serviceAr: 'تسجيل إيجاري', amount: 'AED 250 (VAT inclusive)', remarksEn: 'For Dubai properties only', remarksAr: 'للعقارات في إمارة دبي فقط', beneficiary: 'CRE' },
      { serviceEn: 'Municipality Service Charge', serviceAr: 'رسوم خدمة البلدية', amount: 'AED 210 (VAT inclusive)', remarksEn: 'For lease registration on Municipality system', remarksAr: 'لتسجيل العقد في نظام البلدية', beneficiary: 'CRE' },
      { serviceEn: 'Cheque Replacement', serviceAr: 'استبدال الشيك', amount: 'AED 262.50 (VAT inclusive)', remarksEn: 'Per replacement after receipt issuance', remarksAr: 'لكل استبدال بعد إصدار الإيصال', beneficiary: 'CRE' },
      { serviceEn: 'Cheque Postponement', serviceAr: 'تأجيل الشيك', amount: 'AED 262.50 (VAT inclusive)', remarksEn: 'Max 1 month from original date', remarksAr: 'بحد أقصى شهر من التاريخ الأصلي', beneficiary: 'CRE' },
      { serviceEn: 'Returned/Bounced Cheque', serviceAr: 'الشيك المرتجع', amount: 'AED 525 (VAT inclusive)', remarksEn: 'For each cheque returned by bank', remarksAr: 'لكل شيك يرتجع من البنك', beneficiary: 'CRE' },
      { serviceEn: 'Late Renewal (within 15 days)', serviceAr: 'تأخير التجديد (خلال 15 يوم)', amount: 'AED 525 (VAT inclusive)', remarksEn: 'Renewal within 15 days of expiry', remarksAr: 'تجديد خلال 15 يوم من انتهاء العقد', beneficiary: 'CRE' },
      { serviceEn: 'Late Renewal (within 30 days)', serviceAr: 'تأخير التجديد (خلال 30 يوم)', amount: 'AED 1,050 (VAT inclusive)', remarksEn: 'Renewal within 30 days of expiry', remarksAr: 'تجديد خلال 30 يوم من انتهاء العقد', beneficiary: 'CRE' },
      { serviceEn: 'Name Change / Lease Transfer (Residential)', serviceAr: 'تغيير الاسم / نقل العقد (سكني)', amount: '5% of annual rent', remarksEn: 'Changing lessor during lease period', remarksAr: 'تغيير المستأجر خلال فترة العقد', beneficiary: 'CRE' },
      { serviceEn: 'Name Change / Lease Transfer (Commercial)', serviceAr: 'تغيير الاسم / نقل العقد (تجاري)', amount: '10% of annual rent', remarksEn: 'Changing lessor during lease period', remarksAr: 'تغيير المستأجر خلال فترة العقد', beneficiary: 'CRE' },
      { serviceEn: 'Certification Letters', serviceAr: 'رسائل التصديق', amount: 'AED 100', remarksEn: 'Per certification requested by tenant', remarksAr: 'لكل تصديق يطلبه المستأجر', beneficiary: 'CRE' },
    ...
    paymentToOwner: [
      ...
      { en: '<strong>Statement:</strong> Itemized statement of rent collected, expenses incurred, CRE commission deducted, and net amount payable to Owner.', ar: '<strong>البيان:</strong> بيان مفصل للإيجارات المحصلة، المصروفات المتكبدة، عمولة CRE المخصومة، والمبلغ الصافي المستحق للمالك.' },
    ...
    termination: [
      ...
      { en: '<strong>File Handover:</strong> CRE shall hand over all tenant files, documents, keys, and PMS data within 14 days of termination effective date.', ar: '<strong>تسليم الملفات:</strong> تقوم CRE بتسليم جميع ملفات المستأجرين، الوثائق، المفاتيح، وبيانات نظام الإدارة خلال 14 يوماً من تاريخ سريان الإنهاء.' },
      { en: '<strong>Tenant Communication:</strong> CRE shall notify all existing tenants in writing of the management transition.', ar: '<strong>التواصل مع المستأجرين:</strong> تخطر CRE جميع المستأجرين الحاليين كتابياً بانتقال الإدارة.' },
      { en: '<strong>Continuing Obligations:</strong> CRE shall remain entitled to commissions on leases concluded during the term, even if such commissions become payable after termination.', ar: '<strong>الالتزامات المستمرة:</strong> تظل CRE مستحقة للعمولات على عقود الإيجار المبرمة خلال مدة الاتفاقية، حتى لو أصبحت هذه العمولات مستحقة بعد الإنهاء.' },
    ],
    ...
    confidentiality: [
      ...
      { en: 'CRE shall comply with the UAE Personal Data Protection Law (Federal Decree-Law No. 45 of 2021) and shall implement appropriate technical and organizational measures to protect personal data.', ar: 'تلتزم CRE بقانون حماية البيانات الشخصية لدولة الإمارات (المرسوم بقانون اتحادي رقم 45 لسنة 2021) وتطبق التدابير التقنية والتنظيمية المناسبة لحماية البيانات الشخصية.' },
