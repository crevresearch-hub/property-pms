...
const sections = [
  ...
  },
  {
    ...
    fees: [
      { name: "New Lease Commission (Residential)", amount: "5% of annual rent (min AED 1,050)", beneficiary: "CRE" },
      { name: "New Lease Commission (Commercial)", amount: "10% of annual rent (min AED 1,050)", beneficiary: "CRE" },
      { name: "Renewal Fee (Residential)", amount: "AED 850 fixed", beneficiary: "CRE" },
      { name: "Renewal Fee (Commercial)", amount: "AED 1,500 fixed", beneficiary: "CRE" },
      { name: "EJARI Registration", amount: "AED 250 fixed", beneficiary: "CRE" },
      { name: "Municipality Fee", amount: "AED 210 fixed", beneficiary: "CRE" },
      { name: "Bounced Cheque Fine", amount: "AED 525 fixed", beneficiary: "CRE" },
      { name: "Cheque Replacement", amount: "AED 262.50 fixed", beneficiary: "CRE" },
      { name: "Late Renewal (15 days)", amount: "AED 525 fixed", beneficiary: "CRE" },
      { name: "Late Renewal (30 days)", amount: "AED 1,050 fixed", beneficiary: "CRE" },
